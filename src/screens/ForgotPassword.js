  ...
  const [success,setSuccess] = useState(false);
    ...
    const sendEmail=async()=>{
      ...
      try{
        ...
        const response = await axios.post("https://www.mediconnect.live/auth/forgot-password", {
          email: email
      }, {
          headers: {
    ...
    return(
      ...
      ></TextInput>
        <TouchableOpacity onPress={sendEmail} style={styles.button}><Text style={styles.buttontext}>Send</Text></TouchableOpacity>
        </View>
        <Modal isVisible={isModalVisible}>
          <View style={styles.ModalView}>
              ...
              <TouchableOpacity onPress={()=>{setIsModalVisible(false)}} style={styles.ModalButton}><Text style={styles.ModalButtonText}>Back</Text></TouchableOpacity>
