...
import "./index.css";
registerLicense(
  "Ngo9BigBOggjHTQxAR8/V1NMaF5cXmBCf1FpRmJGdld5fUVHYVZUTXxaS00DNHVRdkdmWX5fdXRVRGdfV0F0V0U=",
);
    ...
    <div style={{ display: "flex", margin: "0px" }}>
      ...
      <div
        style={{
          ...
          marginLeft: hideSidebar ? "0px" : "240px",
        }}
      >
        <div className="content-wrapper">
          <Routes>
            ...
            <Route
              path="/soap-note-generation/:appointmentId/:patientId"
              element={<SOAPNoteGenerationPage />}
            />
