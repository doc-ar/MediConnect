...
function Signup() {
  ...
  const handleProfilePicChange = async (e) => {
    ...
    try {
      const response = await fetch("https://www.mediconnect.live/file/upload-avatar", {
        method: "POST",
        headers: {
  ...
  const handleInitialSignup = async (e) => {
    ...
    try {
      ...
      const loginResponse = await silentLogin({ email, password, role: "doctor" }).unwrap();
...
/>
            ...
            <button  className='action-btn' type="submit" disabled={isInitialLoading || isSilentLoginLoading}>
        ...
        <a href="/login" className="auth-link">Login</a>
          ...
          <form onSubmit={handleCompleteSignup}>
            ...
            <select className='designation-dropdown' value={designation} onChange={(e) => setDesignation(e.target.value)} required>
            ...
            <select className='qualification-dropdown'
              value=""
              onChange={(e) => {
                if (e.target.value) {
      ...
      <div className="tags-container">
        {qualifications.map((qualification) => (
          <div key={qualification} className="tag">
            ...
            <input type="text" placeholder="Contact No." value={contactNo} onChange={(e) => setContactNo(e.target.value)} required pattern="^\d{11}$"  title="Please enter a valid 11-digit contact number" />
            ...
            />
            <button className='action-btn' type="submit" disabled={isCompleteLoading}>
