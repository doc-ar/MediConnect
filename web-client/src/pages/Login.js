...
function Login() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await fetch('https://www.mediconnect.live/auth/forgot-password', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="auth-container" id="login-container">
      <div className="auth-box">
        ...
        <p id="forgot-pass" onClick={() => setShowModal(true)} style={{ cursor: 'pointer', color: '#233B69'}}>
        ...
        <>
          ...
          <div className="login-modal">
            <div className="login-modal-content">
              ...
              />
              <button className="action-btn" onClick={handleForgotPassword}>Submit</button>
